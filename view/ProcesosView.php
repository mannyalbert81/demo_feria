		...
		<div class="col-md-12 col-lg-12 col-xs-12">
				...
				<section class="content">
                   <div class='nav-tabs-custom'>
                    ...
                    <li id="nav_nivel0"><a href="#nivel0" data-toggle="tab" >Nivel 1</a></li>
               	   </ul>
                    ...
                    <div class="tab-pane" id="nivel1">
                        <div class="row">
        					<div class="col-lg-1 col-md-1">
        						<a class="btn btn-app">
        						<i class="fa fa-folder-o"></i> ANALISIS
        						</a>
        					</div>
        					<div class="col-lg-1 col-md-1">
        						<a class="btn btn-app">
        						<i class="fa fa-folder-o"></i> GARANTIA
        						</a>
        					</div>
        					<div class="col-lg-1 col-md-1">
        						<a class="btn btn-app">
        						<i class="fa fa-folder-o"></i> SEGUROS
        						</a>
        					</div>
        					<div class="col-lg-2 col-md-2">
        						<a class="btn btn-app">
        						<i class="fa fa-folder-o"></i> DESEMBOLSO
        						</a>
        					</div>
        					<div class="col-lg-1 col-md-1">
        						<a class="btn btn-app">
        						<i class="fa fa-folder-o"></i> AVALUOS
        						</a>
        					</div>
        					<div class="col-lg-2 col-md-2">
        						<a class="btn btn-app">
        						<i class="fa fa-folder-o"></i> ACTUALIZACIONES
        						</a>
        					</div>
        					<div class="col-lg-1 col-md-1">
        						<a class="btn btn-app">
        						<i class="fa fa-folder-o"></i> GARANTE
        						</a>
        					</div>
        					<div class="col-lg-2 col-md-2">
        						<a class="btn btn-app">
        						<i class="fa fa-folder-o"></i> CODEUDOR
        						</a>
        					</div>
