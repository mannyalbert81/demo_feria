                ...
                if(is_array($rsnivel0)){
                    ...
                    foreach ($rsnivel0 as $res){
                        ...
                        if (!file_exists($dir))
                         ...
                         //Parametros de Condiguraciï¿½n
                         
                         $tamaï¿½o = 10; //Tamaï¿½o de Pixel
                         $level = 'L'; //Precisiï¿½n Baja
                         $framSize = 3; //Tamaï¿½o en blanco
                         $contenido = $code; //Texto
                         
                         
                         
                         //Enviamos los parametros a la Funciï¿½n para generar cï¿½digo QR
                         QRcode::png($contenido, $filename, $level, $tamaï¿½o, $framSize);
